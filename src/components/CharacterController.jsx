...
export const CharacterController = () => {
  const { WALK_SPEED, RUN_SPEED, ROTATION_SPEED } = useControls(
    "Character Control",
    {
      ...
      RUN_SPEED: { value: 4.4, min: 0.2, max: 12, step: 0.1 },
      ROTATION_SPEED: {
        value: degToRad(0.5),
        min: degToRad(0.1),
        max: degToRad(5),
    ...
    if (rb.current) {
      ...
      if (movement.x !== 0 || movement.z !== 0) {
        ...
        vel.z =
          ...
          speed;
        if (speed === RUN_SPEED) {
          setAnimation("Fox_Run_InPlace");
        } else {
          setAnimation("Fox_Walk_InPlace");
        }
        // setAnimation("Scene");
      } else {
        setAnimation("Fox_Idle");
      }
  ...
  return (
    ...
    >
      ...
      <CapsuleCollider
        args={[0.6, 0.7]} // 콜라이더의 반지름과 높이
        position={[0, 1.5, 0]} // 콜라이더의 위치 조정
      />
    </RigidBody>
  );
};
